...
namespace BlueOakBridge.EasyUnity
{
    ...
    {
        public static float ToAbsolute(this float f, FloatRange range) => f.ToAbsolute(range.Min, range.Max);
        public static int ToAbsolute(this int i, IntRange range) => i.ToAbsolute(range.Min, range.Max);

        public static float ToRelative(this float f, FloatRange range) => f.ToRelative(range.Min, range.Max);
        public static float ToRelative(this int i, IntRange range) => i.ToRelative(range.Min, range.Max);
    }
